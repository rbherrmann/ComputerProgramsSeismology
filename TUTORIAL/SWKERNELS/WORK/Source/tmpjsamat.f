...
c-----
        ...
        do 100 i=1,m
            ...
            if(ilvry.eq.2)then
                ...
                suma = suma + dcda(i)*a(i)*qainv(i)
                dgdq(i) = dgdq(i) + factr*dcda(i)*a(i)*qaiqbi
            endif
  100   continue
        if(ilvry.eq.1)then
        WRITE(6,*)'L ga 0',tp,' 0.0 ',factr*suma, ' 0.10'
        WRITE(6,*)'L gb 0',tp,' 0.0 ',factr*sumb, ' 0.10'
        else
        WRITE(6,*)'R ga 0',tp,' 0.0 ',factr*suma, ' 0.10'
        WRITE(6,*)'R gb 0',tp,' 0.0 ',factr*sumb, ' 0.10'
        endif
        gam = factr * (suma + sumb)
        return
        end
